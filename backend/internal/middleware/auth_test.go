...
func TestRejectViewer_AllowsGET(t *testing.T) {
	router := gin.New()
	router.Use(func(c *gin.Context) {
		c.Set("user_id", uuid.New())
		c.Set("user_role", models.RoleViewer)
...
func TestRejectViewer_BlocksPOST(t *testing.T) {
	router := gin.New()
	router.Use(func(c *gin.Context) {
		c.Set("user_id", uuid.New())
		c.Set("user_role", models.RoleViewer)
...
func TestRejectViewer_AllowsNonViewerPOST(t *testing.T) {
	router := gin.New()
	router.Use(func(c *gin.Context) {
		c.Set("user_id", uuid.New())
